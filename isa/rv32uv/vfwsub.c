...
void TEST_CASE1(void) {
  ...
  VLOAD_16(v2, 0xcbc8, 0x55fc, 0xd14e, 0x4fae, 0xd258, 0xd5a4, 0xd5f8, 0x4f66,
  ...
  //              -126.56250000
  VCMP_U32(1, v4, 0xc291a000, 0x4251e000, 0x40df0000, 0x42a89000, 0x40810000,
  ...
  // //               -90740.60156250
  // VLOAD_32(v2, 0x4791c463, 0xc780324e, 0x467c9764, 0xc68b2fb8, 0xc7a73204,
  ...
  // VCMP_U64(2, v4, 0x40f0e790d2000000, 0x40d888f080000000, 0x40e31ae160000000,
...
void TEST_CASE2(void) {
  ...
  VCMP_U32(3, v4, 0x0, 0x4251e000, 0x0, 0x42a89000, 0x0, 0xc29c3800, 0x0,
  ...
  // VCMP_U64(4, v4, 0x0, 0x40d888f080000000, 0x0, 0xc0ddcf1f00000000, 0x0,
...
void TEST_CASE3(void) {
  ...
  VCMP_U32(5, v4, 0x42058000, 0xc2938000, 0xc2e36000, 0xc06e0000, 0xc2eee000,
  ...
  // double dscalar_32;
  // //                              -138614.20312500
  // BOX_FLOAT_IN_DOUBLE(dscalar_32, 0xc8075d8d);
  ...
  // //               -297052.53125000
  // VLOAD_32(v2, 0x48e7027e, 0x481e2dc5, 0xc828fd39, 0xc89d3fc3, 0xc8ed1cf2,
  //          0xc915db06, 0xc83281a2, 0x47ec8d39, 0xc96a049d, 0x4890262d,
  //          0x488948fb, 0xc9337dbe, 0xc93f66e9, 0x48cd8ef5, 0x496903a2,
  //          0xc8910b91);
  // asm volatile("vfwsub.vf v4, v2, %[A]" ::[A] "f"(dscalar_32));
  ...
  // VCMP_U64(6, v4, 0x4122ab1448000000, 0x411258b520000000, 0xc0e0cfd600000000,
...
void TEST_CASE4(void) {
  ...
  VLOAD_8(v0, 0xAA, 0xAA);
  VCLEAR(v4);
  asm volatile("vfwsub.vf v4, v2, %[A], v0.t" ::[A] "f"(dscalar_16));
  ...
  VCMP_U32(7, v4, 0x0, 0xc2938000, 0x0, 0xc06e0000, 0x0, 0x421f8000, 0x0,
  ...
  // VLOAD_8(v0, 0xAA, 0xAA);
  // VCLEAR(v4);
  // asm volatile("vfwsub.vf v4, v2, %[A], v0.t" ::[A] "f"(dscalar_32));
  ...
  // VCMP_U64(8, v4, 0x0, 0x411258b520000000, 0x0, 0xc106643f20000000, 0x0,
...
void TEST_CASE5(void) {
  ...
  //              82.50254822
  VLOAD_32(v2, 0xc2b84f83, 0x41dd5c22, 0xc0b5eb7f, 0x429de715, 0x4266178c,
  ...
  //              -4.18495178
  VCMP_U32(9, v4, 0xc19cbe0c, 0x42de3708, 0xc20a0d70, 0x42356e2a, 0x430f45e3,
  ...
  // VLOAD_64(v2, 0xc0f3686f189d8b80, 0x40f3edd6a4bdf6fa, 0x40ed8b46011de3ec,
...
void TEST_CASE6(void) {
  ...
  VCMP_U32(11, v4, 0x0, 0x42de3708, 0x0, 0x42356e2a, 0x0, 0xc250306d, 0x0,
  ...
  // VCMP_U64(12, v4, 0x0, 0x40ed37fd597bedf4, 0x0, 0xc1013c4a58f8735c, 0x0,
...
void TEST_CASE7(void) {
  ...
  VLOAD_32(v2, 0xc10c5085, 0x425dd639, 0x428e95f3, 0xc2a94eec, 0xc2a3e0ac,
           0x4296438c, 0xc296e161, 0xc24346a4, 0x3dd31233, 0xc1c9830a,
           0x4246b863, 0x42915358, 0xc1c7453e, 0xc2026094, 0x41696b90,
           0xc25c49f3);
  //                              34.7812
  BOX_HALF_IN_DOUBLE(dscalar_16, 0x5059);
  asm volatile("vfwsub.wf v4, v2, %[A]" ::[A] "f"(dscalar_16));
  ...
  VCMP_U32(13, v4, 0xc22e3421, 0x41a56c72, 0x42120be6, 0xc2eedeec, 0xc2e970ac,
  ...
  // VLOAD_64(v2, 0x4113aa36484b9690, 0x412beba7e3ef80b0, 0xc122f2162d26c1cc,
  ...
  //          0x4128f812f63066de);
  // //                              -83388.08593750
  // BOX_FLOAT_IN_DOUBLE(dscalar_32, 0xc7a2de0b);
  // asm volatile("vfwsub.wf v4, v2, %[A]" ::[A] "f"(dscalar_32));
  ...
  // VCMP_U64(14, v4, 0x4118c126a04b9690, 0x412e77200fef80b0, 0xc120669e0126c1cc,
...
void TEST_CASE8(void) {
  ...
  VLOAD_8(v0, 0xAA, 0xAA);
  VCLEAR(v4);
  asm volatile("vfwsub.wf v4, v2, %[A], v0.t" ::[A] "f"(dscalar_16));
  ...
  VCMP_U32(15, v4, 0x0, 0x41a56c72, 0x0, 0xc2eedeec, 0x0, 0x42216718, 0x0,
  ...
  // VLOAD_8(v0, 0xAA, 0xAA);
  // VCLEAR(v4);
  // asm volatile("vfwsub.wf v4, v2, %[A], v0.t" ::[A] "f"(dscalar_32));
  ...
  // VCMP_U64(16, v4, 0x0, 0x412e77200fef80b0, 0x0, 0xc116cc88b8185b2a, 0x0,
